...
bool BallCreateInit(entt::registry& reg_) {
    EventRegister(BallUpdateEvent,[&reg_](std::shared_ptr<zmq::socket_t> socket_, const std::shared_ptr<BallUpdateEvent>& message_, const int64_t& tm_,const string& rout_id_) {
